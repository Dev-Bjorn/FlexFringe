...
void MCTSConfig::log() const {
    ...
    LOG_S(INFO) << "Use Finisher: " << USE_FINISHER;
    LOG_S(INFO) << "Finisher Algorithm: " << FINISH_ALGORITHM;
    LOG_S(INFO) << "Force Until Terminal: " << FORCE_UNTIL_TERMINAL;
    ...
    LOG_S(INFO) << "Expansion Weighted Extend Scoring: " << EXPANSION_WEIGHTED_EXTEND_SCORING;
    ...
    LOG_S(INFO) << "Rollout Weighted Extend Scoring: " << ROLLOUT_WEIGHTED_EXTEND_SCORING;
